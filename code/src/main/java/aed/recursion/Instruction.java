...
public class Instruction {
    enum InstType {
        CALL, RET, PUSH, PRINT, ADD, DROP, DUP, EQ, MULT, IF_SKIP, SUB, SWAP
    };
    ...
    public String toString() {
        switch (getInstType()) {
            case CALL:
                return "CALL" + " " + getNameParm();
            case RET:
                return "RET";
            case PUSH:
                return "PUSH" + " " + getIntParm();
            case PRINT:
                return "PRINT";
            case ADD:
                return "ADD";

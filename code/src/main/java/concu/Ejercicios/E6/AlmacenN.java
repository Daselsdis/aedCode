...
class AlmacenN {
    ...
    //
    //
    private Semaphore plazasEscribir;
    private Semaphore plazasLeer;
    ...
    public AlmacenN(int n) {
        ...
        //
        //
        plazasEscribir = new Semaphore(n);
        plazasLeer = new Semaphore(0);
    }
